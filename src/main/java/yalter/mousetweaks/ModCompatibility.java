...
public class ModCompatibility extends DeobfuscationLayer {
    ...
    public static int getModGuiContainerID(GuiScreen guiScreen) {
        if (guiScreen instanceof IMTModGuiContainer) return Constants.MTMODGUICONTAINER;

        if (forestryInstalled && Reflection.forestry.isInstance("GuiForestry", guiScreen)) return Constants.FORESTRY;
    ...
    public static void modClickSlot(int modGuiContainerID, GuiScreen guiScreen, Object modContainer, Slot targetSlot,
        ...
        switch (modGuiContainerID) {
            ...
            case Constants.NEI:
                windowClick(
                        getWindowId(asContainer(modContainer)),
